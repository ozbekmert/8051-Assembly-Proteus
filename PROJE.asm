...
SETB TR1
SETB TF0
MOV IE, #93H ;ENABLE SERIAL INTERRUPT AND TIMER 0 INTERRUPT
SETB INTR
SJMP $	
...
READTEMP:
	CLR WRITE
	SETB WRITE				;STARTS CONVERSION
CYC1: JB INTR, CYC1;WAÝT UNTÝL ALL DATA ÝS SEND
	CLR READ				;END OF CONVERSION
	MOV CURRENTTEMP, P2;TRANSFER DATA TO ACC
	SETB READ				;TO GET READY FOR NEXT INPUT
	RET
...
OKTEMP:					         ;IF VALID TEMP VALUE...
	ACALL SHOWTEMP
	MOV IE, #93H			;VALID INPUT IS ENTERED, TIMER CAN START
	SETB TR0
	LJMP F
PASS2: JNB 02H, PASS3
